...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'customers_customer', 'phone_number',
                      self.gf('localflavor.us.models.PhoneNumberField')(default=0, max_length=20),
                      keep_default=False)

        # Adding field 'Customer.state'
        db.add_column(u'customers_customer', 'state',
                      self.gf('localflavor.us.models.USStateField')(default='IA', max_length=2),
                      keep_default=False)

        # Adding field 'Customer.zip_code'
        db.add_column(u'customers_customer', 'zip_code',
                      self.gf('localflavor.us.models.USPostalCodeField')(default=0, max_length=2),
                      keep_default=False)
